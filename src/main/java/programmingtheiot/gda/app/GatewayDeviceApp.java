...
public class GatewayDeviceApp
{
	...
	// public methods
	/**
	 * Initializes and starts the application. Calls startManager() on the device data manager instance.
	 * 
	 */
	...
	/**
	 * Stops the application. Calls stopManager() on the device data manager instance.
	 * 
